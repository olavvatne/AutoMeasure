...
*/
public class CustomParticleAnalyzer implements PlugInFilter, Measurements {
    ...
    */
    ...
    public CustomParticleAnalyzer(int options, int measurements, ResultsTable rt, double minSize, double maxSize) {
        this(options, measurements, rt, minSize, maxSize, 0.0, 1.0);
    }

    /** Default constructor */
    public CustomParticleAnalyzer() {
        slice = 1;
    }
    ...
    public int setup(String arg, ImagePlus imp) {
        this.arg = arg;
        this.imp = imp;
        this.setResultsTable(new ResultsTable());
        /*if (imp==null)
    ...
    public boolean showDialog() {
       ...
       /* String size = gd.getNextString(); // min-max size
        ...
        Analyzer.setMeasurements(NOTHING);
        Analyzer.setMeasurement(CENTER_OF_MASS, true);
        Analyzer.setMeasurement(AREA, true);
        return true;
    }
